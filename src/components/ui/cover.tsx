...
export const Cover = ({
  ...
  return (
    <div
      ...
      ref={ref}
      className='relative mt-5 cursor-pointer hover:bg-neutral-900  group/cover inline-block dark:bg-neutral-900 bg-black px-2 py-2  transition duration-200 rounded-sm'
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
