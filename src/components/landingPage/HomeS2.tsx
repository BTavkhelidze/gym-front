  ...
  return (
    <div className="max-w-[1200px] w-full flex justify-between items-center m-auto mt-[90px]">
      <div className="">
        ...
        <Image src="/image/situp.png" width={241} height={359} alt="situp" className="relative mt-[-220px] ml-[199px]" />
      </div>
      <div className="max-w-[540px] w-full">
        ...
        <button className="max-w-[237px] w-full h-[68px] bg-none border-[1px] border-[#E43071] rounded-[38px] mt-[20px] text-[#E43071]">View the FAQ</button>
      </div>
    </div>
  );
}
